...
var fingerprint = function () {
  function murmurhash3_32_gc(key, seed) {
    ...
    while (i < bytes) {
      ...
      ++i;
      k1_1 =
        ((k1_1 & 65535) * c1 + ((((k1_1 >>> 16) * c1) & 65535) << 16)) &
        4294967295;
      k1_1 = (k1_1 << 15) | (k1_1 >>> 17);
      k1_1 =
        ((k1_1 & 65535) * c2 + ((((k1_1 >>> 16) * c2) & 65535) << 16)) &
        4294967295;
      h1 ^= k1_1;
      h1 = (h1 << 13) | (h1 >>> 19);
      var h1b =
  ...
  return new Promise(function (resolve, reject) {
    var fingerprints = {
      ...
      webglInfo: function () {
        return new Promise(function (resolve) {
          ...
          var output = {};
          var debugExtension = context.getExtension(
          ...
          function font_test(font) {
            return new Promise(function (resolve) {
              ...
              for (var index_2 in baseFonts) {
                ...
                body.appendChild(span);
                detected =
                  span.offsetWidth != defaultWidth[baseFonts[index_2]] ||
                  span.offsetHeight != defaultHeight[baseFonts[index_2]];
                body.removeChild(span);
                if (detected) {
      ...
      errors: function () {
        return new Promise(function (resolve) {
          var errorTests = [
            ...
            new Function(
              "try{abc.xyz=123;return -1}catch(e){return e.message}"
            ),
            new Function(
              "try{(1).toString(1000);return -1}catch(e){return e.message}"
            ),
            new Function(
              "try{[...undefined].length;return -1}catch(e){return e.message}"
            ),
            new Function(
              "try{var x=new Array(-1);return -1}catch(e){return e.message}"
            ),
          ];
          var err = new Array();
    ...
    Promise.all(promises)
      .then(function (k) {
        ...
        var persistentFp = murmurhash3_32_gc(
